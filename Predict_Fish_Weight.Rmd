...
Find the best 2 predictors of the weight of a perch.
...
The best model using two variables are Length 1 and Length 3.  
...
The best model using two variables are Length 3 and Width.   

## Final Summary Statements. 

Perch= The best model using two variables is height and width.  
Pike= The best model using two variables are Length 1 and Length 3.  
Roach=The best model using two variables are Length 3 and Width.  